        ...
        >
          ...
          >
            <div>
              <img
                className="postImage"
                src={this.props.articlePost.feature_img}
                alt={this.props.articlePost.title}
              />
            </div>

            <div className="pt-4">
              <p className="postCategoryText pl-1">
                {this.props.articlePost.category}
              </p>
...
class Articles extends React.Component {
  ...
  fetchPostsArticles = () => {
    //function to fetch the API data and assigned it to an array state for mapping
